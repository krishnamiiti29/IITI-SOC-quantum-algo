...
def _m3_correct(counts, backend, qubits):
    ...
    Skipped for a local AerSimulator: with no readout noise model attached,
    there's nothing for M3 to correct, and calibrating against a simulator
    isn't meaningful the way it is on real hardware.
    """
